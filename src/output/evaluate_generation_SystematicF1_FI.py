...
FILE_PATH = "./src/output/chatgpt_replicate_3_mcq_mmlu_zs_Wrapping.csv"
...
with open(FILE_PATH) as file:
    ...
    for row in csvreader:
        ...
        # if check_free_form_follow(raw_zs_free_form_result) == 0:
        #     print(raw_zs_free_form_result)
        #     break
        ff_systematic += compute_metric(
        ...
        # if check_bolding(raw_zs_bolding_result) == 0:
        ...
        brackets_systematic += compute_metric(
        ...
        placeholder_systematic += compute_metric(
