...
Generate your binary list such that each element is in a new line. Generate your answer step-by-step. {wrapping}"""
        ...
        all_cnt += 1
        saved_data.append([query, positive, negative, cot_python_answer, cot_special_answer, cot_bullet_answer, cot_newline_answer])
...
with open("./src/output/mistral_cot_scidocs_15Apr.csv", "w") as file:
    csvwriter = csv.writer(file)
    csvwriter.writerow(["query", "positive", "negative", "cot_python_answer", "cot_special_answer", "cot_bullet_answer", "cot_newline_answer"])
